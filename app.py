...
with tab0:
    ...
    st.write("This is your one-stop solution for finding information about diseases, medications, diets, and workouts.")
    
    st.subheader("Features:")
    st.markdown("- **Medications & Diets:** Find medications and diets for specific diseases.")
    st.markdown("- **Workouts:** Discover workouts to improve your health.")
    
    st.subheader("How to Use:")
    st.write("Navigate through the tabs to explore different features:")
    st.write("1. **Medications & Diets:** Select a disease to view medications and diets.")
    st.write("2. **Workouts:** Select a workout type to view details.")
...
with tab4:
    ...
    if st.button("Predict Breast Cancer"):
        breast_cancer_prediction = make_breast_cancer_prediction([float(mean_radius), float(mean_texture), float(mean_perimeter), float(mean_area), float(mean_smoothness)])
